...
const appJsx = [
  ...
  { ancla: 'function TablaReferenciaPagosArrendatarioLiquidacionDeposito', titulo: 'COMPONENTE - TABLA REFERENCIA PAGOS ARRENDATARIO', descripcion: 'Recibos del arrendatario que originan la liquidacion al depositante.' },
