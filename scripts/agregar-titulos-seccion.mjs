...
const appJsx = [
  ...
  { ancla: 'const calcularComisionInhPeriodoContratoEstadoCuenta', titulo: 'ESTADOS CUENTA INH - COMISION POR PERIODO', descripcion: 'Comision INH e IVA causados segun recaudo del arrendatario.' },
  { ancla: 'const normalizarRangoFechasEstadoCuentaInh', titulo: 'ESTADOS CUENTA INH - RANGO DE FECHAS', descripcion: 'Normaliza fecha inicio/fin y filtra periodos incluidos.' },
  { ancla: 'const construirResumenesPeriodoEstadoCuentaInh', titulo: 'ESTADOS CUENTA INH - RESUMEN POR PERIODO', descripcion: 'Comisiones, mora, cobranza e IVA liquidados en el rango seleccionado.' },
  { ancla: 'const construirResumenesPeriodoConsolidadoEstadoCuentaInh', titulo: 'ESTADOS CUENTA INH - CONSOLIDADO TODOS LOS CONTRATOS', descripcion: 'Suma comisiones, mora, cobranza e IVA de todos los contratos por periodo.' },
  ...
  { ancla: 'const calcularTotalesResumenesPeriodoEstadoCuentaInh', titulo: 'ESTADOS CUENTA INH - TOTALES POR PERIODO', descripcion: 'Suma consolidada de comisiones, mora, cobranza e IVA al corte.' },
  { ancla: 'function EstadoCuentaInhPorPeriodos', titulo: 'COMPONENTE - ESTADO DE CUENTA INH POR PERIODOS', descripcion: 'Extracto imprimible de comisiones, mora, cobranza e IVA por periodo.' },
